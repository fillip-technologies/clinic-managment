...
<section class="pt-36 pb-20 px-6" style="background: linear-gradient(135deg, var(--color-primary), var(--color-blue));">
    <div class="max-w-4xl mx-auto text-center text-white">
        <span class="inline-block px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-5 bg-white/15">Contact</span>
        <h1 class="text-4xl sm:text-5xl font-extrabold mb-5">Book a Visit at RCDHO</h1>
        <p class="text-white/80 text-lg">For new patients, follow-up, drug evaluation, investigations and ultrasound appointments.</p>
    </div>
</section>
...
<section class="py-10 px-6" style="background: var(--color-dark);">
    <div class="max-w-5xl mx-auto grid md:grid-cols-3 gap-6">
        ...
        <a href="https://www.rcdho.org" target="_blank" class="rounded-lg p-5 bg-white/10 border border-white/10 text-white">
    ...
    <div class="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10">
        <div class="rounded-lg bg-white p-8 shadow-sm border border-emerald-100">
            ...
            <form action="#" method="POST" class="space-y-4">
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <input type="text" name="name" placeholder="Patient name" class="w-full px-4 py-3 rounded-lg border border-emerald-100 outline-none focus:border-emerald-600">
                    <input type="tel" name="phone" placeholder="Mobile number" class="w-full px-4 py-3 rounded-lg border border-emerald-100 outline-none focus:border-emerald-600">
                </div>
                <select name="visit_type" class="w-full px-4 py-3 rounded-lg border border-emerald-100 outline-none focus:border-emerald-600">
                    <option>New patient</option>
                    <option>Old patient / follow-up</option>
                    <option>Drug evaluation</option>
                    <option>Investigation / ultrasound</option>
                </select>
                <textarea name="message" rows="4" placeholder="Brief concern or appointment note" class="w-full px-4 py-3 rounded-lg border border-emerald-100 outline-none focus:border-emerald-600"></textarea>
                <button class="w-full py-3 rounded-lg text-white font-bold" style="background: var(--color-primary);">Send Request</button>
            </form>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-lg bg-white p-7 shadow-sm border border-emerald-100">
                ...
                <p class="text-sm mt-4 text-gray-600">Sunday closed. Call service and night service unavailable as per clinic note.</p>
            </div>
        </div>
    </div>
</section>
