            ...
            <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6 md:p-8">
                ...
                <form id="doctorForm" class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="password"
                                    class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent pr-12"
                    ...
                    <div class="flex gap-3 pt-2">
                        <button type="submit"
                            class="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2.5 px-6 rounded-xl transition duration-200 flex items-center gap-2 shadow-md hover:shadow-lg">
                            <i class="fas fa-save"></i> Save Doctor
                        </button>
                        <button type="button" id="cancelFormBtn"
                            class="bg-slate-200 hover:bg-slate-300 text-slate-700 font-semibold py-2.5 px-6 rounded-xl transition duration-200">
                            Cancel
                        </button>
                    </div>
                </form>
                    ...
                    <thead class="bg-slate-50 border-b border-slate-200">
                        <tr>
                            ...
                            <th class="text-left px-4 py-3 text-xs font-semibold text-slate-600 uppercase tracking-wider">
                                PIN</th>
                            <th
                                class="text-center px-4 py-3 text-xs font-semibold text-slate-600 uppercase tracking-wider">
                                Actions</th>
                        </tr>
                    </thead>
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <form action="{{ route('doctor.delete', $doctor->id) }}" method="POST"
                                            ...
                                            <button type="submit"
                                                class="w-9 h-9 rounded-lg bg-red-100 text-red-600 hover:bg-red-600 hover:text-white flex items-center justify-center transition">
    ...
    <script>
        (function() {
            ...
            function resetForm() {
                form.reset();
                editIndex = null;
                document.querySelector('#doctorForm button[type="submit"]').innerHTML =
                    '<i class="fas fa-save"></i> Save Doctor';
            ...
            function editDoctor(index) {
                ...
                editIndex = index;
                document.querySelector('#doctorForm button[type="submit"]').innerHTML =
                    '<i class="fas fa-pen"></i> Update Doctor';
