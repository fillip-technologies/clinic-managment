                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="insulin_start_date" id="insulin_start_date"
                                    value="{{ old('insulin_start_date', !empty($data->start_insulin_date) ? \Carbon\Carbon::parse($data->start_insulin_date)->format('Y-m-d') : '') }}"
                                    placeholder="DD/MM/YYYY"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="insulin_stop_date" id="insulin_stop_date"
                                    value="{{ old('insulin_stop_date', !empty($data->stop_insulin_date) ? \Carbon\Carbon::parse($data->stop_insulin_date)->format('Y-m-d') : '') }}"
                                    placeholder="DD/MM/YYYY"
                                    class="w-full rounded-xl border border-[#d3dfea] pl-4 pr-10 py-2.5 text-sm bg-[#fafdff] input-focus cursor-pointer dmy-datepicker">
                                <div class="absolute inset-y-0 right-0 flex items-center pr-3.5 pointer-events-none text-slate-400">
                                    <i class="far fa-calendar-alt text-slate-400 text-sm"></i>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                    ...
                    <div><label class="block text-xs font-semibold text-[#2f5a77]">BMI (kg/m²)</label>
                        <input type="number" step="0.01" name="bmi" value="{{ old('bmi') }}"
                            placeholder="auto"
                            class="w-full rounded-xl border border-[#d3dfea] px-3 py-2 text-sm input-focus">
                    </div>
                    <div><label class="block text-xs font-semibold text-[#2f5a77]">Waist / Height ratio</label>
                        <input type="number" step="0.01" name="waist_height_ratio"
                            value="{{ old('waist_height_ratio') }}" placeholder="0.0"
                            class="w-full rounded-xl border border-[#d3dfea] px-3 py-2 text-sm input-focus">
                    </div>
                    ...
                    <div><label class="block text-xs font-semibold text-[#2f5a77]">Waist (cm)</label>
                        <input type="number" step="0.1" name="waist" value="{{ old('waist') }}"
                            placeholder="cm"
                            class="w-full rounded-xl border border-[#d3dfea] px-3 py-2 text-sm input-focus">
                    </div>
                    <div><label class="block text-xs font-semibold text-[#2f5a77]">Hip (cm)</label>
                        <input type="number" step="0.1" name="hip" value="{{ old('hip') }}"
                            placeholder="cm"
                            class="w-full rounded-xl border border-[#d3dfea] px-3 py-2 text-sm input-focus">
                    </div>
                    <div><label class="block text-xs font-semibold text-[#2f5a77]">Waist/Hip ratio</label>
                        <input type="number" step="0.01" name="waist_hip_ratio"
                            value="{{ old('waist_hip_ratio') }}" placeholder="0.0"
                            class="w-full rounded-xl border border-[#d3dfea] px-3 py-2 text-sm input-focus">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                    ...
                    <div><label class="block text-xs font-semibold text-[#2f5a77]">Physical activity</label>
                        <select name="physical_activity"
                            ...
                            <option value="Active" {{ old('physical_activity') == 'Active' ? 'selected' : '' }}>Active
                            </option>
                        </select>
                    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                    ...
                    <div><label class="block text-xs font-semibold text-[#2f5a77]">Urine cast cell</label>
                        <input type="text" name="urine_cast_cell" value="{{ old('urine_cast_cell') }}"
                            placeholder="cells"
                            class="w-full rounded-xl border border-[#d3dfea] px-3 py-2 text-sm input-focus">
                    </div>
                    ...
                    <div><label class="block text-xs font-semibold text-[#2f5a77]">I. calcium</label>
                        <input type="text" name="ionized_calcium" value="{{ old('ionized_calcium') }}"
                            placeholder="mg/dL"
                            class="w-full rounded-xl border border-[#d3dfea] px-3 py-2 text-sm input-focus">
                    </div>
                    ...
                    <div><label class="block text-xs font-semibold text-[#2f5a77]">TG.</label>
                        <input type="text" name="triglycerides" value="{{ old('triglycerides') }}"
                            placeholder="mg/dL"
                            class="w-full rounded-xl border border-[#d3dfea] px-3 py-2 text-sm input-focus">
                    </div>
                    ...
                    <div><label class="block text-xs font-semibold text-[#2f5a77]">Dex Skp.. TEst</label>
                        <input type="text" name="dex_suppression_test" value="{{ old('dex_suppression_test') }}"
                            placeholder="result"
                            class="w-full rounded-xl border border-[#d3dfea] px-3 py-2 text-sm input-focus">
                    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div><label class="block text-xs font-semibold text-[#2f5a77]"><i class="fas fa-eye"></i>
                            OPHTHALMIC EX</label>
                        <input type="text" name="ophthalmic_exam" value="{{ old('ophthalmic_exam') }}"
                    ...
                    <div><label class="block text-xs font-semibold text-[#2f5a77]"><i class="fas fa-heart"></i> Car.
                            Echo Ev.</label>
                        <input type="text" name="echo_exam" value="{{ old('echo_exam') }}"
