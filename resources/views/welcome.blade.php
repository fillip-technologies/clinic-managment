...
<section class="relative overflow-hidden">
    ...
    <div class="absolute inset-0">
        <img src="{{ asset('images/doctor-bg.jpg') }}"
            class="w-full h-full object-cover"
            alt="Neurosurgery Background">
    ...
    <div class="relative max-w-7xl mx-auto px-6 lg:px-8 pt-32 pb-20">
        ...
        <div class="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div class="text-white space-y-6">
                ...
                <!-- Stats -->
                <div class="flex gap-8 pt-6 text-white/90">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-white/70">Cases Treated</p>
                    </div>

                    <div>
                        <p class="text-2xl font-bold">95%</p>
                        <p class="text-sm text-white/70">Success Rate</p>
                    </div>
