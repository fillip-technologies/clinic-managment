...
class PatientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'c_peptide' => 'nullable|string|max:100',
            'insulin_antibodies' => 'nullable|string|max:100',
            'mody_biomarkers' => 'nullable|string|max:150',
            ...
            'temprature' => 'nullable|numeric|between:0,150',
            'temperature' => 'nullable|numeric|between:0,150',
        ...
        PatientClinicalRecord::create([
            ...
            'insulin_antibodies' => $request->insulin_antibodies,
            'mody_biomarkers' => $request->mody_biomarkers,
